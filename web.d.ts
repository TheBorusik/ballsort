...
declare namespace $ {
    const $mol_theme: Record<"back" | "hover" | "card" | "current" | "special" | "text" | "control" | "shade" | "line" | "focus" | "field" | "image" | "spirit", $mol_style_func<"var", unknown>>;
}
...
declare namespace $ {
    let $mol_gap: Record<"blur" | "block" | "space" | "round" | "text", $mol_style_func<"var", unknown>>;
}
