...
declare namespace $ {
    ...
    class $mol_style_func<Name extends $mol_style_func_name, Value = unknown> extends $mol_decor<Value> {
        ...
        static steps(value: number, step_position: 'jump-start' | 'jump-end' | 'jump-none' | 'jump-both' | 'start' | 'end'): $mol_style_func<"steps", (number | "end" | "jump-start" | "jump-end" | "jump-none" | "jump-both" | "start")[]>;
...
declare namespace $ {
     ...
     */
    const $mol_theme: Record<"focus" | "image" | "line" | "text" | "hue" | "back" | "hover" | "card" | "current" | "special" | "control" | "shade" | "field" | "spirit" | "hue_spread", $mol_style_func<"var", unknown>>;
}
...
declare namespace $ {
     ...
     */
    let $mol_gap: Record<"blur" | "text" | "page" | "block" | "space" | "round" | "emoji", $mol_style_func<"var", unknown>>;
}
